(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("pixi5_ts_webpack", ["PIXI"], factory);
	else if(typeof exports === 'object')
		exports["pixi5_ts_webpack"] = factory(require("PIXI"));
	else
		root["pixi5_ts_webpack"] = factory(root["PIXI"]);
...
var GameParticle_1 = __webpack_require__(4);
var GameSpine_1 = __webpack_require__(6);
var GameManager = /** @class */ (function () {
    ...
    GameManager.prototype.loading = function () {
        var _this = this;
        ...
        this.app.loader.onComplete.add(function () {
            _this.onLoaderComplete(_this.app.loader);
        });
        this.app.loader.load();
    };
    GameManager.prototype.onLoaderComplete = function (loader) {
    ...
    GameManager.prototype.showSprite = function (texture) {
        var pic = new PIXI.Sprite(texture);
        pic.position.set(0, 0);
        this.app.stage.addChild(pic);
    };
    GameManager.prototype.showSpineAnimation = function (skeletonData) {
        var animation = new GameSpine_1.GameSpine(skeletonData);
        animation.play();
        animation.position.set(-200, 200);
        this.app.stage.addChild(animation);
    };
    GameManager.prototype.addParticles = function (config) {
        var particle = new GameParticle_1.GameParticle();
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.GameParticle = void 0;
var pixi_js_1 = __webpack_require__(0);
var PIXIparticles = __webpack_require__(5);
var GameParticle = /** @class */ (function (_super) {
    __extends(GameParticle, _super);
    function GameParticle() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    GameParticle.prototype.init = function (config, app) {
        var _this = this;
        var particleResource = config.emitterResource;
        var imagesName = config.particleImages;
        var particleImages = new Array();
        imagesName.forEach(function (img) {
            particleImages.push(pixi_js_1.Texture.from(img));
        });
        this.name = config.name;
        this.particleEmitter = new PIXIparticles.Emitter(this, particleImages, particleResource);
        var pos;
        if (config.pos) {
            pos = config.pos;
        }
        ...
        var speed = config.speed ? config.speed : 0.03;
        app.ticker.add(function () {
            _this.particleEmitter.update(speed);
        });
    };
    GameParticle.prototype.setEmit = function (emit) {
        if (emit === void 0) { emit = true; }
        this.particleEmitter.emit = emit;
    };
    return GameParticle;
}(pixi_js_1.Container));
exports.GameParticle = GameParticle;
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LinkedListContainer", function() { return LinkedListContainer; });
...
/* harmony import */ var pixi_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
...
if (parseInt((/^(\d+)\./).exec(pixi_js__WEBPACK_IMPORTED_MODULE_0__["VERSION"])[1], 10) < 5) {
...
var LinkedListContainer = /** @class */ (function (_super) {
    ...
    LinkedListContainer.prototype.getLocalBounds = function (rect, skipChildrenUpdate) {
        ...
        var result = pixi_js__WEBPACK_IMPORTED_MODULE_0__["DisplayObject"].prototype.getLocalBounds.call(this, rect);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.GameSpine = void 0;
var GameSpine = /** @class */ (function (_super) {
    __extends(GameSpine, _super);
    function GameSpine() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    GameSpine.prototype.play = function (animationName) {
