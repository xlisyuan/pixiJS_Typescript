...
var GameManager = /** @class */ (function () {
    ...
    GameManager.prototype.showSpriteRotate = function (loader) {
        //create a sprite from a 'gecko.png' image
        var pic = new PIXI.Sprite(loader.resources['pic'].texture);
    ...
    GameManager.prototype.showSpineAnimation = function (loader) {
        //console.error(PIXI.spine);
        var spine = new PIXI.spine.Spine(loader.resources['spine'].spineData);
